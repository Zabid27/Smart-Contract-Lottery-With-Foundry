...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    //data structure. Let's use address array and storage variable
    ...
    function enterRaffle() external payable {
        ...
        // require(msg.value >= i_entranceFee, SendMoreToEnterRaffle()) //available on 0.8.26
    ...
    function performUpkeep(bytes calldata /*performData*/) external {
        ...
        // If enough time has indeed passed. We gonna get our random number from chainlink vrf v2.5
